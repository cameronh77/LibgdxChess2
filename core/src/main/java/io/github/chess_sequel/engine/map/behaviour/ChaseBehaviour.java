...
/**
 * Moves the NPC one step toward the player's king each turn.
 * Triggers dialogue/combat if it reaches the king's tile.
 */
public class ChaseBehaviour extends MapBehaviour {
